...
basic_socket::basic_socket(basic_socket&& rhs) noexcept {
    swap(*this, rhs);
}
basic_socket& basic_socket::operator=(basic_socket&& rhs) noexcept {
    swap(*this, rhs);
    return *this;
}
...
void swap(basic_socket& a, basic_socket& b) noexcept {
    swap(a.fd_, b.fd_);
    swap(a.on_disconnect_, b.on_disconnect_);
    swap(a.on_read_, b.on_read_);
    swap(a.on_write_, b.on_write_);
